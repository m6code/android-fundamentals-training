...
public class BaseCls extends AppCompatActivity {
    private static final String TRANSITION_TYPE = "Transition Type";

    public static final String ANDROID_TRANSITION = "switchAndroid";
    public static final String BLUE_TRANSITION = "switchBlue";
